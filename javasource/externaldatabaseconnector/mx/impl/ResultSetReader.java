...
public class ResultSetReader {
    ...
    public ResultSetReader(final ResultSet resultSet, final IMetaObject metaObject, final Map<String, String> columnAttributeMapping) {
        this.rsIter = new ResultSetIterator(resultSet, metaObject, columnAttributeMapping);
    }
